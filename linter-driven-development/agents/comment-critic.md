...
**Scope:** EVERY comment in the diff — doc comments, in-body comments, and test
comments. Directives (compiler and build pragmas, the linter's suppression directive, doc-test output markers) are not comments; skip
them.
