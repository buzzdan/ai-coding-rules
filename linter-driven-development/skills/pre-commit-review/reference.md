...
| R10 | state | `../../rules/R10-concurrency-safety.md` | concurrent tasks without exit paths or owners; unguarded shared-state writes; production sleeps; decorative mutexes |
