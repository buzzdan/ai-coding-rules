#!/usr/bin/env bash
# Repo-brain conformance gate for the {{.Plugin}} plugin.
#
...
# adapter block. This build carries the {{.Lang}} adapter; with no code files, the
...
{{include "scripts/repo-brain-adapter.sh"}}
