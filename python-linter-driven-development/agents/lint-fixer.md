...
(`FBT001`), mypy `arg-type`/`assignment` mismatches fixed at the call or the
annotation (never with `# type: ignore`). Complexity and design failures you do NOT redesign — refactoring is
