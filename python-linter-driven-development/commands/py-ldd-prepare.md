...
4. **Apply survivors** via `Skill(python-linter-driven-development:refactoring)` in
...
gates, use `/py-ldd-quickfix`; for a read-only assessment, `/py-ldd-analyze`.
